...
const parameterChangeDefinition = {
    ...
    35377: { name: "MAX_COMBINED_VERTEX_UNIFORM_COMPONENTS", type: "-", max: 7, factor: 13 },
    35379: { name: "MAX_COMBINED_FRAGMENT_UNIFORM_COMPONENTS", type: "-", max: 7, factor: 11 },
  ...
  function copyCanvasToWebgl(canvas, webGLVersion = 'webgl') {
    ...
    if (!context.getShaderParameter(fragmentShader, context.COMPILE_STATUS)) {
      ...
      console.error('webgl: failed to compile fragmenter shader.');
      return;
    }
    ...
    const size = 5;          // 2 components per iteration
  ...
  module.exports = { parameterChangeDefinition, copyCanvasToWebgl, initializeParameterDefinitions };
